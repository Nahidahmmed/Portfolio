...
export default function Welcome() {
  return (
    <div className="lg:flex md:flex w-full lg:px-[10%] pt-[15%] h-screen">
    ...
    <img className='w-[300px] rounded-xl mx-auto md:mt-5 border-4 border-gray-200 hover:border-gradient-500 hover:scale-105 transform transition duration-300 ease-in-out' src={image} alt="" />
</div>
    </div>
  );
}
